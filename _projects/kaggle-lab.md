...
incidental — the artifact I care about is the log. 15 of those 37 runs made things
worse and they're all still in it, so the experiment graph shows the dead-ends, not
just the clean climb. The full story is in the [write-up](/writing/kaggle-lab/).
